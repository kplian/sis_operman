...
?>
<script>
Phx.vista.UniConsAddCmp=Ext.extend(Phx.arbInterfaz,{
	...
	ActList:'../../sis_mantenimiento/control/UniCons/listarUniConsAddCmp',
	...
	onButtonNew:function(){
			...
			Phx.vista.UniConsAddCmp.superclass.onButtonNew.call(this);
			//if(nodo.)
    ...
    onButtonAct: function(){
        Phx.vista.UniConsAddCmp.superclass.onButtonAct.call(this);
        this.tbar.items.get('b-new-' + this.idContenedor).disable();
    },
	 
	loadValoresIniciales:function(){
		var tipo = 'uc';
		Phx.vista.UniConsAddCmp.superclass.loadValoresIniciales.call(this);
	...
	onButtonEdit:function(){
		...
		Phx.vista.UniConsAddCmp.superclass.onButtonEdit.call(this);
	},
	...
	successBU:function(resp){
    	...
    	east:{
		 ...
		 onBeforeLoad:function(treeLoader, node) {
				...
				Phx.vista.UniConsAddCmp.superclass.onBeforeLoad.call(this,treeLoader, node)
		},
