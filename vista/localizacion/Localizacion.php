...
<script>
	Phx.vista.Localizacion = Ext.extend(Phx.arbInterfaz, {
		...
		constructor: function(config) {
			...
			this.baseParams = {};
			this.ctxMenu.items.get('mni-tarTPM-' + this.idContenedor).hide();
			this.ctxMenu.items.get('mni-consolEqMed-' + this.idContenedor).hide();
			this.ctxMenu.items.get('mni-detFichaTecVar-' + this.idContenedor).hide();
			this.ctxMenu.items.get('mni-equipos-' + this.idContenedor).menu.items.get('mni-rcm-' + this.idContenedor).hide();
			this.ctxMenu.items.get('mni-equipos-' + this.idContenedor).menu.items.get('mni-tpm-' + this.idContenedor).hide();
