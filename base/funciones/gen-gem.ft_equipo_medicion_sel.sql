...
BEGIN
	...
	/*********************************    
 	#TRANSACCION:  'GM_EQMESP_SEL'
 	#DESCRIPCION:	Consulta de datos
 	#AUTOR:		admin	
 	#FECHA:		21-05-2017 21:46:02
	***********************************/

	if(p_transaccion='GM_EQMESP_SEL')then
     				
    	begin
    		--Sentencia de la consulta
			v_consulta:='select
						eqmesp.id_equipo_medicion,
						eqmesp.id_equipo_variable,
						eqmesp.medicion,
						eqmesp.estado_reg,
						eqmesp.fecha_medicion,
						eqmesp.hora,
						eqmesp.observaciones,
						eqmesp.usuario_ai,
						eqmesp.fecha_reg,
						eqmesp.id_usuario_reg,
						eqmesp.id_usuario_ai,
						eqmesp.fecha_mod,
						eqmesp.id_usuario_mod,
						usu1.cuenta as usr_reg,
						usu2.cuenta as usr_mod	
						from gem.tequipo_medicion eqmesp
						inner join segu.tusuario usu1 on usu1.id_usuario = eqmesp.id_usuario_reg
						left join segu.tusuario usu2 on usu2.id_usuario = eqmesp.id_usuario_mod
				        where  ';
	...
	/*********************************    
 	#TRANSACCION:  'GM_EQMESP_CONT'
 	#DESCRIPCION:	Conteo de registros
 	#AUTOR:		admin	
 	#FECHA:		21-05-2017 21:46:02
	***********************************/

	elsif(p_transaccion='GM_EQMESP_CONT')then
