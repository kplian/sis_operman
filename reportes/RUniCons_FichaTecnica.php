...
require_once dirname(__FILE__).'/pxpReport/Report.php';
 ...
 class CustomReport extends TCPDF {
	...
	public function Header() {
        ...
        $this->SetFont('','B');
        $this->Cell($width2, $height/4, ''/*'GMAN-RG-SM-006'*/, "", 0, 'C', false, '', 0, false, 'T', 'C');
...
Class RUniCons_FichaTecnica extends Report {
	...
	function write($fileName) {
		...
		*/
		...
		$pdf->Cell($width2, $height, 'COPELME S.A.', 'B', 0, 'L', false, '', 0, false, 'T', 'C');
		...
		$pdf->Cell(185, $height, 'IDENTIFICACIÓN', 1, 0, 'C', true, '', 0, true, 'T', 'C');
