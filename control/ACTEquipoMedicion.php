...
class ACTEquipoMedicion extends ACTbase{    
	...
	function listarMedicionesSP(){
		$this->objParam->defecto('ordenacion','fecha_medicion');
		$this->objParam->defecto('dir_ordenacion','desc');
		if($this->objParam->getParametro('tipoReporte')=='excel_grid' || $this->objParam->getParametro('tipoReporte')=='pdf_grid'){
			$this->objReporte = new Reporte($this->objParam, $this);
			$this->res = $this->objReporte->generarReporteListado('MODEquipoMedicion','listarMedicionesSP');
		} else{
			$this->objFunc=$this->create('MODEquipoMedicion');	
			$this->res=$this->objFunc->listarMedicionesSP();
		}
		$this->res->imprimirRespuesta($this->res->generarJson());
	}
	...
	function listarMediciones(){
		...
		if($this->objParam->getParametro('tipoReporte')=='excel_grid' || $this->objParam->getParametro('tipoReporte')=='pdf_grid'){
			$this->objReporte = new Reporte($this->objParam, $this);
			$this->res = $this->objReporte->generarReporteListado('MODEquipoMedicion','listarMediciones');
		} else{
			$this->objFunc=$this->create('MODEquipoMedicion');	
			$this->res=$this->objFunc->listarMediciones();
		}
		$this->res->imprimirRespuesta($this->res->generarJson());
	}
