...
/*
	...
	/*function listarUniConsAddCmp(){
		//obtiene el parametro nodo enviado por la vista
		$node=$this->objParam->getParametro('node');
		$id_uni_cons=$this->objParam->getParametro('id_uni_cons_tmp');
		
		$this->objParam->addParametro('id_uni_cons',$id_uni_cons);
		$this->objFunSeguridad=$this->create('MODUniCons');
		$this->res=$this->objFunSeguridad->listarUniConsAddCmp($this->objParam);
	...
	function listarUniConsAddCmp(){
		...
		if($node=='id'){
				$this->objParam->addParametro('id_padre','%');
				$this->objParam->addParametro('id_uni_cons_tmp',$this->objParam->getParametro('id_uni_cons_tmp'));
			}
			else {
				$this->objParam->addParametro('id_padre',$id_uni_cons);
			}
